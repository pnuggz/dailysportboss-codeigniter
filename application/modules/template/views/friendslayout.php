<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="<?php echo base_url(); ?>css/friendslayout.css"/>
    ...
    <body class="body">
        <div class="container">
            <div class="main-content">
                ...
                if($first_bit==('draft') && $second_bit==('lobby')) {
                    $this->load->module('draft');
                    $this->load->view('draft/league_contests_entry');
                } else {
                ...
                if($first_bit==('draft') && $second_bit==('details')) {
                    $this->load->module('draft');
                    $this->load->view('draft/details');
                } else {
                ...
                if($first_bit==('friends') && $second_bit==('')) {
                    $this->load->module('friends');
                    $this->load->view('friends/friends_leagues_home');
                } else {
                ...
                if($first_bit==('friends') && $second_bit==('details')) {
                    $this->load->module('friends');
                    $this->load->view('friends/details');
                } else {
