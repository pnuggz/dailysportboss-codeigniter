...
<head>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>js/dom.js?v=201610171054"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>js/countries.js?v=201610171054"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>js/subscribe.js?v=201610171054"></script>
    <link href="https://fonts.googleapis.com/css?family=Muli" rel="stylesheet">

    <link rel="stylesheet" type="text/css" media="screen" href="<?php echo base_url(); ?>css/homelayout.css?v=201610171054"/>
</head>
