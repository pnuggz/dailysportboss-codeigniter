...
class Mdl_games extends CI_Model
{
    ...
    function get_all_players_list_contest($contest_id, $user_id, $user_entry_number)
    {
        ...
        foreach ($contest_user_entry->result() as $row) {
            ...
            JOIN teams ON players_phases.teams_phases_id = teams.id
            JOIN (
    ...
    function get_team_fp($contest_id)
    {
        $query = $this->db->query('
            ...
            FROM (
                ...
                WHERE (P1.date BETWEEN \'2016-03-19\' AND \'2016-03-20\') AND (P2.date BETWEEN \'2016-03-19\' AND \'2016-03-20\') AND (P3.date BETWEEN \'2016-03-19\' AND \'2016-03-20\') AND (P4.date BETWEEN \'2016-03-19\' AND \'2016-03-20\') AND (P5.date BETWEEN \'2016-03-19\' AND \'2016-03-20\') AND (P6.date BETWEEN \'2016-03-19\' AND \'2016-03-20\') AND (P7.date BETWEEN \'2016-03-19\' AND \'2016-03-20\') AND (P8.date BETWEEN \'2016-03-19\' AND \'2016-03-20\') AND (P9.date BETWEEN \'2016-03-19\' AND \'2016-03-20\') AND (P10.date BETWEEN \'2016-03-19\' AND \'2016-03-20\') 
            ) T1
    ...
    function get_player_fp($contest_id, $user_id, $user_entry_number)
    {
        ...
        foreach ($contest_user_info->result() as $row) {
            ...
            $query = $this->db->query('
                ...
                WHERE (T2.date BETWEEN \'' . $event_date . '\' AND DATE_ADD(\'' . $event_date . '\',INTERVAL 5 DAY)) 
